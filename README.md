...
3. Создать нужную директорию и скопировать папку с приложение `mkdir -p /home/myuser/crud_app/ && cp -r app /home/myuser/crud_app/`
4. Создать виртуальное окружение `python3 -m venv /home/myuser/crud_app/app/venv` 
5. Перейти в папку с приложением активировать виртуальное окружени `cd /home/myuser/crud_app/app/ && source venv/bin/activate`
6. Установать зависмости (с работающим витуальным окружением) `pip install -r requirements.txt`
